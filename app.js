...
const addCardComponent = (
  ...
  console.log(image, programming, tokopedia, url, title);
  ...
  const cardElement = isExpired
    ...
    : `
        ...
        <a href="${programming}" target="_blank" rel="noopener" class="card__actions__button">Programming</a>
        <a href="${tokopedia}" target="_blank" rel="noopener" class="card__actions__button" hidden>Tokopedia</a>
      </div>`
              : ''
          }
          <div class="card__header">
            <a href="${url || programming}" target="_blank"
